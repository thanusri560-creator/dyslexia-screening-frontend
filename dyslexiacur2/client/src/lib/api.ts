...
export const audioPredictionAPI = {
  // Predict dyslexia from audio file
  predictFromAudio: async (audioBlob: Blob): Promise<{
    ...
    if (!response.ok) {
      ...
      throw new Error(error.error || 'Failed to predict');
    }
